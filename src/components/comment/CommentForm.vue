<template>
  <div class="mb-6 relative">
    ...
    <button 
      v-if="!isExpanded" 
      @click="expandForm"
      class="w-full bg-white dark:bg-gray-800 shadow-sm dark:shadow-gray-900/30 rounded-xl p-3 border border-blue-100 dark:border-blue-900/30 flex items-center justify-between transition-all duration-300 hover:shadow-md hover:border-blue-200 dark:hover:border-blue-800/40 group"
    >
    ...
    >
      ...
      >
        <div class="bg-white dark:bg-gray-800 shadow-md dark:shadow-gray-900/30 rounded-xl p-4 border border-blue-100 dark:border-blue-900/30 overflow-hidden relative">
          <!-- 装饰波浪背景 -->
          ...
          <!-- 未登录状态提示和登录链接 -->
          <div v-if="!isLoggedIn" class="mb-4 p-5 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/30">
            <div class="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-blue-500 dark:text-blue-400 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <template v-if="isLoggedIn">
            <div class="relative">
              <textarea
                v-model="content"
                class="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 text-gray-800 dark:text-gray-200 border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 focus:outline-none transition-all duration-300 min-h-[100px] resize-none placeholder-gray-400 dark:placeholder-gray-500"
                placeholder="说点什么吧..."
            ...
            <div class="flex justify-between items-center mt-3">
              ...
              <div class="flex space-x-2">
                <button
                  @click="collapseForm"
                  class="px-4 py-2 rounded-full font-medium text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-300"
                >
                  取消
                </button>
                ...
                <button
                  ...
                  class="px-4 py-2 rounded-full font-medium text-white transition-all duration-300 relative overflow-hidden group"
                  :class="[canSubmit ? 'bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 shadow-md hover:shadow-lg active:scale-95' : 'bg-gray-300 dark:bg-gray-700 cursor-not-allowed']"
                >
                  <!-- 按钮内闪光效果 -->
                  <span 
                    v-if="canSubmit" 
